      ...
      <div className="p-5 flex-grow">
        ...
        {option.institutes && (
          <p className="text-sm text-gray-500">
            <span className="font-semibold">Institutes:</span> {option.institutes}
          </p>
        )}
      </div>
      <button
      ...
      <div className="max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
        <div className="text-center">
          <img
            ...
            alt="Other Streams Illustration"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <div className="space-y-4">
              <div className="flex items-center mb-2">
                <GraduationCap className="w-7 h-7 text-blue-500 mr-3 flex-shrink-0" />
        ...
        <div className="bg-white rounded-xl shadow-md p-6 md:p-8">
          <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-6">
            {toggle === "degrees" ? "Popular Courses"
             : toggle === "exams" ? "Top Institutes"
             : "Career Options"}
          </h2>
